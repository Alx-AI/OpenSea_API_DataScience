def parse_BAYCs_data(BAYCs_dict):
    
    BAYCs_id = BAYCs_dict['token_id']
    
    try:
        creator_username = BAYCs_dict['creator']['user']['username']
    except:
        creator_username = None
    try:
        creator_address = BAYCs_dict['creator']['address']
    except:
        creator_address = None
    
    try:
        owner_username = BAYCs_dict['owner']['user']['username']
    except:
        owner_username = None
    
    owner_address = BAYCs_dict['owner']['address']
    
    traits = BAYCs_dict['traits']
    num_sales = int(BAYCs_dict['num_sales'])
        
    result = {'BAYC_id': BAYCs_id,
